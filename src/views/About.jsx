...
function About() {
  ...
  return (
    ...
    <div className='place-items-end-safe pt-[40px] flex flex-wrap px-[50px] py-[50px] ml-[200px] mr-[200px]' >
    <div className='border-2 border-gray-200 px-4 py-4 rounded-2xl ml-[20px]'>
     <img src='https://avatar.iran.liara.run/public/21' className='size-44  ml-1 '/>
      <p className='py-4 px-10 bg-amber-300 mt-[-10px] rounded-lg'>Ayush Thakre</p>
      <p  className='px-10'>UI/UX Designer</p>
      <div className='flex mt-4 ml-4'>
      <a href='https://www.instagram.com/' target='_blank'>
       <img src='https://cdn-icons-png.flaticon.com/128/1384/1384031.png ' className='size-8 bg-gray-200 p-1 rounded-xl transition-transform duration-200 hover:scale-120 hover:bg-gray-300'/></a>
       <a href='' target='_blank'>
       <img src='https://cdn-icons-png.flaticon.com/128/1006/1006771.png' className='size-8 bg-gray-200 py-1 px-1 rounded-xl ml-8'/>  
       </a>
       <a href='' target='_blank'>
       <img src='https://cdn-icons-png.flaticon.com/128/646/646094.png' className='size-8 bg-gray-200 py-1 px-1 rounded-xl ml-8'/></a>
      
      </div>
      </div>

      <div className='border-2 border-gray-200 px-4 py-4 rounded-2xl ml-[150px]'>
