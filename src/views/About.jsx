...
<main className="container mx-auto p-4 md:px-8 lg:px-12"> 
      <p className='text-4xl md:text-6xl text-center font-bold my-8'>Versatile team masters every <span className='text-lime-500 transition-colors'>challenge!</span></p>    
  
    <section className='my-12'>
    <h1 className='text-2xl md:text-3xl my-4 text-center text-gray-400 font-medium '>Our mission is to provide an intuitive, robust and community-driven platform <br/>for both 
...
<br/>
<section >
  <h1 className='text-3xl md:text-4xl font-extrabold mt-8 mb-2 '>What We Offer</h1>
  <br/>
  <h2 className='text-lg md:text-xl font-medium text-gray-500'> HACKNITY is designed to cater to a wide spectrum of hosting needs. </h2>

  <span className='text-gray-500 md:text-xl mb-8 font-medium block'>Here's what makes us the ideal choice for your game hosting :</span>
<div className=' bg-gray-100 p-6 rounded-lg'>
  <h1  className='text-2xl font-extrabold text-lime-500 mb-2'>For Online Games</h1>
 <div className='text-xl text-gray-500 font-light'>
 <p ><span  className=' text-black font-semibold '>Robust Server Infrastructure:</span><br/> Our infrastructure is built for scalability, capable of handling sudden 
  spikes in player numbers without a hitch.</p>

<p><span className=' text-black font-semibold'>Easy Deployment & Management:</span> <br/>Our user-friendly dashboard allows for quick game uploads, 
...
<p><span className=' text-black font-semibold '> Secure Content Delivery: 
  <br/>
  </span> Even for offline games, secure and efficient content delivery is crucial. We provide reliable hosting for your game files, ensuring players can download your game quickly and safely.
  </p>
  <p>
...
<section className="my-12">
  <hr className="border-t-2 border-dotted border-lime-500 my-8" />
 <h1 className='text-3xl font-extrabold text-center mb-8'>MEET OUR <span className=' text-lime-500 underline  '>HACKNITY</span> TEAM </h1>
